    ...
    <div id="page-container">
      <div id="content-wrap">
        <div>
          ...
          {movieData ? (
            <div
              className="holder grid sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2"
              style={{ margin: "1vw 3vw" }}
            >
              <div
            ...
            <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
              ...
              <div className="md:7/12 lg:w-6/12">
                <h2 className="text-2xl text-gray-900 font-bold md:text-4xl">
                  Welcome to CrudeMovieDb
                </h2>
                <p className="mt-6 text-gray-600">
                  {" "}
                  Browse through our library and collect movies at home or while
                  traveling on tablet, phone or TV.
                </p>
                <p className="mt-4 text-gray-600">
                  Create an Account and collect your favorite Movies!
                </p>
              </div>
            </div>
          </div>
